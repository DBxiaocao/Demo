 ...
 */
class RecommendViewBinder : ItemViewBinder<ItemBean, RecommendViewBinder.ViewHolder>() {

    override fun onCreateViewHolder(inflater: LayoutInflater, parent: ViewGroup): ViewHolder {
        val root = inflater.inflate(R.layout.item_list_view_type_recommend, parent, false)
